...
public class Vendedor extends Cadastro{
    ...
    public void mostrarProdutos(){
        for (Map.Entry<String, List<String>> entry : mapProdutoComVendedor.entrySet()) {
            ...
            for (int i = 0; i < produtos.size(); i +=4) {
                String nomeVendedor = produtos.get(i);
                String nomeProduto = produtos.get(i+1);
                String valorUnitario = produtos.get(i+2);
                String codigo = produtos.get(i+3);
    ...
    public static void setMapProdutoComVendedor(HashMap<String, List<String>> mapProdutoComVendedor) {
        Vendedor.mapProdutoComVendedor = mapProdutoComVendedor;
    }
    @Override
    ...
    public static HashMap<String, String> getMapEmailNomeVendedor() {
        return mapEmailNomeVendedor;
    }
    public static HashMap<String, String> getMapEmailCpfDoVendedor() {
        return mapEmailCpfDoVendedor;
    }
    public static void setListaDeVendedores(List<Vendedor> listaDeVendedores) {
        Vendedor.listaDeVendedores = listaDeVendedores;
    }
}