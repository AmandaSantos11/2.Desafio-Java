...
public class Cliente extends Cadastro{
    ...
    List<String> historicoDeCompraCliente = new ArrayList<>();
        ...
        do {
            try {
                ...
                if(produtos.size() != 0){
                    ...
                    historicoDeVendasDoVendedor.add(nome); historicoDeVendasDoVendedor.add(nomeDoCliente); historicoDeVendasDoVendedor.add(nomeDoProdutoDoUsuario); historicoDeVendasDoVendedor.add(codigoDoProdutoDoUsuario); historicoDeVendasDoVendedor.add(valorUnitarioDoProdutoDoUsuario); historicoDeVendasDoVendedor.add(quantidade); historicoDeVendasDoVendedor.add(valorTotalConvertido);
                }
                else{
                    continuar=true;
                }
            ...
            do{
                try{
                    ...
                    switch (escolhaConvertida){
                        case 1:
                            historicoDeCompraCliente.clear();
