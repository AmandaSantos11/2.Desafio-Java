...
public class Cliente extends Cadastro{
    ...
    public static void adicionarClientesNaLista(){
        listaDeClientes.add(new Cliente("Lola","12309845671","lola.ortega@gmail.com","333333"));
        listaDeClientes.add(new Cliente("Matheus","78907213451","math32@gmail.com","111111"));
        for(Cadastro cadastro : listaDeClientes){
            ...
            gerarSenhaCriptografada.put(cpf,senhaCriptografada);
        }
    }
    ...
    public void cadastrarNoSistema(){
        ...
        Cliente clienteNovo = new Cliente(nome, cpf, email,senha);
        gerarSenhaCriptografada.put(cpf,senhaCriptografada);
    ...
    public void login() throws UnsupportedOperationException{
        ...
        do{
            try {
                System.out.println("Digite sua senha:");
                senha = digite.nextLine();
                String senhaCripto = gerarSenhaCriptografada.get(cpf);
